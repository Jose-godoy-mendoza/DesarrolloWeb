...
class Menu(models.Model):
    ...
    idmenupadre = models.ForeignKey('self', models.DO_NOTHING, db_column='IdMenuPadre', blank=True, null=True)  # Field name made lowercase.
    url = models.CharField(db_column='URL', max_length=60, db_collation='Modern_Spanish_CI_AS', blank=True, null=True)  # Field name made lowercase.
...
class Tarea(models.Model):
    id = models.CharField(primary_key=True, max_length=32, db_collation='Modern_Spanish_CI_AS')
...
class Users(models.Model):
    ...
    username = models.CharField(db_column='Username', max_length=40, db_collation='Modern_Spanish_CI_AS', blank=True, null=True)  # Field name made lowercase.
    password = models.CharField(max_length=102, db_collation='Modern_Spanish_CI_AS', blank=True, null=True)
    idrol = models.ForeignKey(Rol, models.DO_NOTHING, db_column='IdRol', blank=True, null=True)  # Field name made lowercase.
